  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>水位视频管理</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
    ...
    <el-dialog title="上传" v-model="uploadVisible" width="35%">
      <el-form label-width="85px">
        <el-form-item label="视频编号">
          <el-input v-model="query.videoId"></el-input>
        </el-form-item>
      ...
      <el-upload
        ...
        :drag="{plus}"
        action="http://localhost:8084/videoWaterLevel/uploadVideoWaterLevel"
        multiple
        :show-file-list="true"
        name=file
        :data="query"
...
import { getVideoWaterLevelList } from "../../api/device-manager-api";
export default {
  ...
  setup() {
    ...
    const getData = () => {
      getVideoWaterLevelList(query).then((res) => {
